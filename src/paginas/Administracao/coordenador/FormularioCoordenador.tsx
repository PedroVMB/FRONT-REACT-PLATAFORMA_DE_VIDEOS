import {
  ...
  export const FormularioCoordenador = () => {
    ...
    useEffect(() => {
      if (parametros.id) {
        http.get<IUser>(`coordenador/${parametros.id}`).then((resposta) => {
    ...
    const aoSubmeterForm = (evento: React.FormEvent<HTMLFormElement>) => {
      ...
      if (parametros.id) {
        http.put(`coordenador`, user).then(() => {
          alert("Coordenador atualizado com sucesso!");
        });
      } else {
        http.post("coordenador", user).then(() => {
    ...
    return (
      <>
        <Card>
          <CardHeader title="Formulário de Cadastro Coordenador" />
