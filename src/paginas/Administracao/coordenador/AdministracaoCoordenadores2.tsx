...
const AdministracaoCoordenadores2 = () => {
    const [coordenadores, setCoordenadores] = useState<IUser[]>([]);

    useEffect(() => {
        http.get<ApiResponse>('coordenador')
            .then(resposta => {
                    ...
                    <TableBody>
                        {Array.isArray(coordenadores) && coordenadores.map(coordenador => (
                                <TableRow key={coordenador.id}>
                                    ...
                                    <TableCell>
                                        <RouterLink to={`/admin/coordenador/${coordenador.id}`}>editar</RouterLink>
                                    </TableCell>
                                    <TableCell>
...
export default AdministracaoCoordenadores2;
